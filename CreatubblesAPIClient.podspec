#
#  Be sure to run `pod spec lint CreatubblesAPIClient.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of CreatubblesAPIClient."
  ...
  s.description  = <<-DESC
			Api framework for Creatubbles app.
                   DESC
  ...
  s.source_files = "CreatubblesAPIClient/**/*.{swift}", "CreatubblesAPIClient/**/*.{h,m}"
